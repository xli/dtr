Gem::Specification.new do |spec|
  ...
  spec.test_files = ["test/acceptance/agent_working_env_test.rb", "test/acceptance/dtr_package_task_test.rb", "test/acceptance/general_test.rb", "test/acceptance/raketasks_test.rb", "test/acceptance/sync_codebase_test.rb", "test/acceptance/sync_logger_test.rb", "test/agent_helper.rb", "test/logger_stub.rb", "test/test_helper.rb", "test/unit/adapter_test.rb", "test/unit/facade_test.rb", "test/unit/test_unit_test.rb", "test/unit/working_env_test.rb", "testdata/a_failed_test_case.rb", "testdata/a_file_system_test_case.rb", "testdata/a_test_case.rb", "testdata/a_test_case2.rb", "testdata/an_error_test_case.rb", "testdata/another_project", "testdata/another_project/passed_test_case.rb", "testdata/another_project/Rakefile", "testdata/dtr_pkg", "testdata/dtr_pkg/codebase-dump", "testdata/dtr_pkg/codebase-dump/another_project", "testdata/dtr_pkg/codebase-dump/another_project/passed_test_case.rb", "testdata/dtr_pkg/codebase-dump/another_project/Rakefile", "testdata/dtr_pkg/codebase-dump/hacked_run_method_test_case.rb", "testdata/dtr_pkg/codebase-dump/is_required_by_a_test.rb", "testdata/dtr_pkg/codebase-dump/lib", "testdata/dtr_pkg/codebase-dump/lib/lib_test_case.rb", "testdata/dtr_pkg/codebase-dump/package_task_test_rakefile", "testdata/dtr_pkg/codebase-dump/Rakefile", "testdata/dtr_pkg/codebase-dump/raketasks", "testdata/dtr_pkg/codebase-dump/raketasks/Rakefile", "testdata/dtr_pkg/codebase-dump/raketasks/success_test_case.rb", "testdata/dtr_pkg/codebase-dump/scenario_test_case.rb", "testdata/dtr_pkg/codebase-dump/setup_agent_env_test_case.rb", "testdata/dtr_pkg/codebase-dump/sleep_3_secs_test_case.rb", "testdata/dtr_pkg/codebase-dump/verify_dir_pwd", "testdata/dtr_pkg/codebase-dump/verify_dir_pwd/Rakefile", "testdata/dtr_pkg/codebase-dump/verify_dir_pwd/verify_dir_pwd_test_case.rb", "testdata/dtr_pkg/codebase-dump.zip", "testdata/hacked_run_method_test_case.rb", "testdata/is_required_by_a_test.rb", "testdata/lib", "testdata/lib/lib_test_case.rb", "testdata/package_task_test_rakefile", "testdata/Rakefile", "testdata/raketasks", "testdata/raketasks/Rakefile", "testdata/raketasks/success_test_case.rb", "testdata/scenario_test_case.rb", "testdata/setup_agent_env_test_case.rb", "testdata/sleep_3_secs_test_case.rb", "testdata/verify_dir_pwd", "testdata/verify_dir_pwd/Rakefile", "testdata/verify_dir_pwd/verify_dir_pwd_test_case.rb"]
  ...
  spec.has_rdoc = true
  spec.extra_rdoc_files = ["README", "LICENSE.txt", "TODO", "CHANGES"]
  spec.rdoc_options = ["--line-numbers", "--inline-source", "--main", "README", "--title", "\"DTR -- Distributed Test Runner"]
